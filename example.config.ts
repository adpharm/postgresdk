...
export default {
   ...
   * and control query complexity. Applies to both API queries and generated types.
   * 
   * Example: With depth 2, you can query:
   *   /users?include=posts.comments
   * But not:
   *   /users?include=posts.comments.author.posts
   * 
   * @default 3
   */
  includeDepthLimit: 3,
