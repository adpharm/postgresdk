...
function tsTypeFor(pgType: string, opts: { dateType: "date" | "string"; numericMode: "string" | "number" }): string {
  ...
  if (t === "date" || t.startsWith("timestamp")) return opts.dateType === "date" ? "Date" : "string";
...
export function emitTypes(table: Table, opts: { dateType: "date" | "string"; numericMode: "string" | "number" }) {
