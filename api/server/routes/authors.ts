...
const columnEnum = z.enum(["id", "name"]);
...
/**
 * Register all CRUD routes for the authors table
 ...
 */
export function registerAuthorsRoutes(app: Hono, deps: { pg: { query: (text: string, params?: any[]) => Promise<{ rows: any[] }> }, onRequest?: (c: Context, pg: { query: (text: string, params?: any[]) => Promise<{ rows: any[] }> }) => Promise<void> }) {
